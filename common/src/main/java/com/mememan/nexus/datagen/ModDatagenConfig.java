 ...
 * should take place for a given mod by its mod ID. Only useful for Nexus API datagen.
 *
 ...
 * @param dupeStrat The {@link DuplicateDataPolicy} to abide by when generating data. See the {@code enum} itself for
 *                  more info. Defaults to {@link DuplicateDataPolicy#CRASH}.
 ...
 *                              from datagen.
 */
public record ModDatagenConfig(@NotNull String modId, boolean enableDatagen, DuplicateDataPolicy dupeStrat, Set<ProviderType> providerTypesToFullyValidate, Set<ProviderType> disabledProviderTypes) {
}
