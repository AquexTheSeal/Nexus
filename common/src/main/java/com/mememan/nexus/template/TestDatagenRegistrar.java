...
public class TestDatagenRegistrar {
    public static final ModDatagenConfig NEXUS = NexusServices.DATA_GENERATOR.registerConfigForMod(new ModDatagenConfig("nexus", true, DuplicateDataPolicy.CRASH, Set.of(), Set.of()));
}
