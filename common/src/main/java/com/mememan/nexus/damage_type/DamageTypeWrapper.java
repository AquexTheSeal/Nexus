...
public class DamageTypeWrapper {
     ...
     *                              DTW instance, typically obtained through {@link Level#registryAccess()}.
     *
    ...
    /**
     * Constructs a builder chain in which certain datagen properties can be assigned and re-built with in this DTW
     * instance. Also sets this DTW instance's {@link #builder} to the newly-constructed {@link DTWBuilder} instance.
     *
     ...
     *
     * @return The copied message ID, or a blank string if the {@link #builder} is {@code null} or the value itself is
     * {@code null}/a blank string.
     */
    ...
    /**
     * Gets the localized death message {@link Component} for the parent damage type. This is typically parsed and
     * formatted for value mapping inside your mod's language file(s). May be {@code null}.
     *
    ...
    /**
     * Gets an immutable view (via {@link ImmutableMap}) of {@link #MAPPED_DTWS}.
     *
     * @return An immutable view (via {@link ImmutableMap}) of {@link #MAPPED_DTWS}.
     */
    public static ImmutableMap<Supplier<ResourceKey<DamageType>>, DamageTypeWrapper> getMappedDtws() {
        return ImmutableMap.copyOf(MAPPED_DTWS);
    }
    ...
    public static class DTWBuilder {
        ...
        /**
         * Sets the copied message ID for the parent damage type. Used in conjunction with
         * {@link #withLocalizedDeathMessageComponent(Component)} as the key during language datagen since datapack
         * registry lookups aren't available on the client.
         *
         * @param copiedMsgId The copied message ID (Essentially the same name you used to register your damage type).
         *
        ...
        /**
         * Sets the localized death message {@link Component} for the parent damage source. This is typically parsed and
         * formatted for value mapping inside your mod's language file(s).
         *
