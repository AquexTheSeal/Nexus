...
public class EntityTypePropertyWrapper<E extends Entity> {
    ...
    /**
     * Gets the {@code Supplier<ClientDataEntry>} from the {@link #builder()} if the builder exists, and it is defined
     * within said builder.
     * May be {@code null}.
     *
     * @return The {@code Supplier<ClientDataEntry>}, or {@code null} if the {@link #builder()} is {@code null} || it
     * isn't defined within said builder.
     */
    @Nullable
